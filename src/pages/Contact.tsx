...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6 animate-slide-up" style={{ animationDelay: '200ms' }}>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:7356424034" className="text-muted-foreground hover:text-gold transition-colors">
                                                7356424034
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div className="glass p-8 rounded-3xl space-y-4 bg-gold/5 border border-gold/20">
                                ...
                                <div className="space-y-2">
                                    <Link to="/track-order" className="block text-gold hover:underline">Track Your Order</Link>
                                    <Link to="/refund-policy" className="block text-gold hover:underline">Returns & Refunds</Link>
                                    <Link to="/shipping-policy" className="block text-gold hover:underline">Shipping Information</Link>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <SEO
                title="Contact Us"
                description="Contact Saree Sutra for order support, sizing help, returns, and saree recommendations."
                url="/contact"
            />
        </div>
    );
