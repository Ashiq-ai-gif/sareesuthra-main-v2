                  ...
                  {items.map((item) => (
                    <div key={item.product.id} className="flex gap-4 group">
                      <div className="h-20 w-16 bg-muted/30 rounded-lg overflow-hidden shrink-0 border border-border/50">
                        <img src={getDirectUrl(item.product.images[0])} alt={item.product.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                      </div>
