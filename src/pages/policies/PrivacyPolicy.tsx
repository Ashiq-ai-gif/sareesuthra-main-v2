                    ...
                    <div className="prose prose-lg max-w-none space-y-8 animate-slide-up">
                        ...
                        <section className="glass p-8 rounded-3xl space-y-4">
                            ...
                            <p className="text-muted-foreground leading-relaxed mt-4">
                                To exercise these rights, please contact us at <a href="mailto:contact@sareesutraofficial.com" className="text-gold hover:underline">contact@sareesutraofficial.com</a>
                            </p>
                        </section>
