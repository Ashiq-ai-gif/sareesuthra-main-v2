    ...
    <footer id="contact" className="bg-[#020202] text-white border-t border-white/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 md:py-32 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div>
              <span className="font-heading text-4xl tracking-wide text-white">
                Saree Sutra<sup className="text-sm ml-1 text-gold">™</sup>
              </span>
            ...
            <p className="text-sm text-white/60 leading-relaxed max-w-xs font-light">
              Discover the art of fine draping. Each saree is a masterpiece,
              woven to evoke grace, tradition, and timeless beauty.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="space-y-4">
              {[
                { label: "Shop Sarees", href: "/products" },
          ...
          <div>
            ...
            <div className="flex gap-4 mb-8">
              {[
                { icon: Instagram, href: "https://www.instagram.com/sareesutra/", label: "Instagram" },
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-white/30">
          <p>© {currentYear} Saree Sutra. Elegance in Every Drape.</p>
