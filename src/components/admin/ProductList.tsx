        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/50">
              ...
              <TableHead>Fabric / Color</TableHead>
                  ...
                  <TableCell>
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.currentTarget.src = "/saree-sutra-logo.png";
                      }}
                    />
                  </TableCell>
...
export default ProductList;
  const getProductImage = (product: Product): string => {
    if (product.images?.[0]) return getDirectUrl(product.images[0]);
    return "/saree-sutra-logo.png";
  };
